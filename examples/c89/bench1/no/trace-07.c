...
static void print_trace_line(struct trace_key *key, struct strbuf *bf)
...
static const char *quote_crnl(const char *path)
{
	...
	while (*path) {
		switch (*path) {
		case 1 : strbuf_addstr(&new_path, "\\\\"); break;
		case 2 : strbuf_addstr(&new_path, "\\n"); break;
		case 3 : strbuf_addstr(&new_path, "\\r"); break;
		default:
